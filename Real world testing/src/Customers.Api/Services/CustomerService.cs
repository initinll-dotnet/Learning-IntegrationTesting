...
public class CustomerService : ICustomerService
{
    ...
    public async Task<bool> CreateAsync(Customer customer)
    {
        ...
        if (existingUser is not null)
        {
            ...
            throw new ValidationException(message, GenerateValidationError(nameof(Customer.Id), message));
        }
    ...
    private static ValidationFailure[] GenerateValidationError(string propertyName, string errorMessage)
    {
        return new []
        {
